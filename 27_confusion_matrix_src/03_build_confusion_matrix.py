...
print('\ntrain_preds.requires_grad:', train_preds.requires_grad)
print('train_preds.grad:', train_preds.grad)
print('train_preds.grad_fn:', train_preds.grad_fn)
...
print('train_preds.argmax(dim=1):', train_preds.argmax(dim=1))
stacked = torch.stack(
    (
        train_set.targets
...
print('\nplot_confusion_matrix(cmt, names):', plot_confusion_matrix(cmt, names))
